"""
Script para extrair dados das notas fiscais usando Tesseract OCR
Processa as imagens PNG já convertidas do PDF
"""
...
os.environ['TESSDATA_PREFIX'] = str(Path(__file__).parent.parent / 'tessdata')
...
class ImageInvoiceExtractor:
    ...
    def process_all_images(self):
        ...
        print(f"{'='*60}")
        print(f"Processando {total} imagens com Tesseract OCR...")
        print(f"{'='*60}\n")
...
def main():
    ...
    try:
        ...
        print(f"[OK] Tesseract {version} encontrado")
    except Exception as e:
        print(f"[ERRO] Tesseract nao encontrado: {e}")
        return
