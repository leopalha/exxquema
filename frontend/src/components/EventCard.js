...
const EventCard = ({ event, isToday = false, isExpanded = false }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -5, boxShadow: '0 25px 50px -12px rgba(249, 115, 22, 0.3)' }}
    ...
    >
      ...
      >
        ...
        {isToday && (
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-orange-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-4"
          >
        ...
        <div className="flex items-start justify-between mb-3">
          <div>
            <h3 className="text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
              {event.dia}
            </h3>
        ...
        {expanded && (
          ...
          >
            <div className="pt-6 space-y-6">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {event.horarios.map((horario, index) => (
                    ...
                    >
                      <div className="flex-shrink-0 text-orange-400 font-mono text-sm font-semibold">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {event.promocoes.map((promo, index) => (
                    <div
                      key={index}
                      className="p-4 bg-gradient-to-br from-orange-500/10 to-orange-600/5 rounded-lg border border-orange-500/30"
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          {promo.preco && (
                            <div className="text-orange-400 font-bold text-lg">{promo.preco}</div>
                          )}
                          {promo.desconto && (
                            <div className="text-orange-400 font-bold text-lg">{promo.desconto}</div>
                          )}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {event.lineup.map((show, index) => (
                      <div
                        key={index}
                        className="p-3 bg-black/30 rounded-lg border border-gray-700 hover:border-orange-500/50 transition-colors"
                      >
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-orange-400 font-semibold text-sm">{show.data}</span>
                          {show.bpm && (
              ...
              {event.temaMes && (
                <div className="p-4 bg-gradient-to-r from-orange-500/20 to-orange-600/10 rounded-lg border-2 border-orange-500/50">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <ul className="space-y-1 text-sm text-gray-300">
                        ...
                        <li>• <span className="text-orange-400 font-semibold">{event.temaMes.premio}</span></li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button className="flex-1 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold py-3 px-6 rounded-lg transition-all shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 hover:scale-105">
                  Reservar Mesa
                </button>
                <button className="flex-1 border-2 border-orange-500 text-orange-400 hover:bg-orange-500 hover:text-white font-semibold py-3 px-6 rounded-lg transition-all hover:scale-105">
                  Adicionar à Agenda
                </button>
              </div>
            </div>
      ...
      {isToday && (
        <motion.div
          className="h-1 bg-gradient-to-r from-orange-500 via-orange-400 to-orange-500"
          animate={{
