...
const TimelineEvent = ({ event, index }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-baseline gap-3 mb-4">
          <div className="text-center">
            <div className="font-bold text-sm uppercase" style={{ color: 'var(--theme-primary)' }}>{event.mes}</div>
        ...
        {/* CTA */}
        <button
          className="w-full text-white font-semibold py-2.5 px-4 rounded-lg transition-all shadow-md hover:shadow-lg hover:scale-105 text-sm"
          style={{
      ...
      <div className="absolute top-1/2 -right-12 w-12 h-0.5 hidden xl:block" style={{
