      ...
      <div className={`min-h-screen bg-black text-white flex flex-col ${className}`}>
        ...
        <AnimatePresence>
          {showUpdatePrompt && (
            ...
            >
              <div className="bg-blue-600 rounded-xl p-4 shadow-2xl border border-blue-500/30">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-white/90 text-xs mb-3 leading-relaxed">
                      Uma atualização está disponível com melhorias e correções
                    </p>
        ...
        <AnimatePresence>
          {!isOnline && router.pathname !== '/offline' && (
            <motion.div
              ...
              animate={{ y: 0, opacity: 1 }}
              exit={{ y: -50, opacity: 0 }}
              className="fixed top-0 left-0 right-0 bg-orange-600 text-white px-4 py-2 text-center text-sm font-medium z-50"
            >
