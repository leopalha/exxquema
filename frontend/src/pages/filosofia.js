...
export default function Filosofia() {
  ...
  return (
    <>
      <Head>
        <title>Nossa Filosofia | Red Light - 5 Pilares de Identidade</title>
        <meta name="description" content="Paradoxo, Liberdade, Intensidade, História e Dualidade: os 5 pilares que definem a experiência Red Light em Botafogo." />
      </Head>
        ...
        >
          ...
          >
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 text-center py-20">
              ...
              >
                RED LIGHT não é apenas um nome. É uma filosofia que celebra a dualidade humana:
          ...
          >
            <div className="max-w-4xl mx-auto px-4 text-center">
              ...
              <p className="text-xl text-white/90 mb-12">
                Filosofia é teoria. Experiência é prática. Venha viver o RED LIGHT.
              </p>
