    ...
    <>
      ...
      <Layout>
        <div className="min-h-screen pt-24 bg-black flex items-center justify-center relative overflow-hidden">
          <div className="max-w-2xl mx-auto px-4 text-center relative z-10">
            ...
            >
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <AlertTriangle className="w-16 h-16 md:w-24 md:h-24 text-[var(--theme-primary)]400 opacity-50" />
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                <Link
                  href="/"
                  className="text-gray-400 hover:text-[var(--theme-primary)]400 transition-colors"
                >
                  → Início
                </Link>
                <Link
          ...
          {/* Decorative lights */}
          <div className="absolute top-20 left-10 w-32 h-32 bg-[var(--theme-primary)]600 rounded-full blur-3xl opacity-20 animate-pulse" />
