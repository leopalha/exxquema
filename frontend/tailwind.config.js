...
module.exports = {
    ...
    extend: {
      colors: {
        ...
        primary: {
          ...
          300: '#fdba74',
          400: '#fb923c',
          500: '#FF6B35', // Main Exxquema Orange
          600: '#F7931E',
          700: '#c2410c',
          800: '#9a3412',
          900: '#7c2d12',
      ...
      backgroundImage: {
        ...
        'exxquema-gradient': 'linear-gradient(135deg, #FF6B35 0%, #F7931E 100%)',
      ...
      boxShadow: {
        ...
        'orange-glow-strong': '0 0 40px rgba(255, 107, 53, 0.5)',
  ...
  plugins: [
    ...
    // Custom plugin for Red Light specific utilities
      ...
      const newComponents = {
        ...
        '.btn-primary': {
          ...
          '&:hover:not(:disabled)': {
            ...
            boxShadow: theme('boxShadow.orange-glow')
          },
          '&:active': {
            transform: 'translateY(0)'
          }
