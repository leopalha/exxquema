...
exports.createOrderSchema = zod_1.z.object({
    type: zod_1.z.enum(['dine_in', 'takeout', 'delivery'], {
    ...
    payment_method: zod_1.z.enum(['credit_card', 'debit_card', 'pix', 'cash'], {
        required_error: 'Método de pagamento é obrigatório',
        invalid_type_error: 'Método de pagamento inválido',
    }),
    use_cashback: zod_1.z
        .number()
...
exports.updateOrderStatusSchema = zod_1.z.object({
    status: zod_1.z.enum(['pending', 'confirmed', 'preparing', 'ready', 'completed', 'cancelled'], {
        required_error: 'Status é obrigatório',
        invalid_type_error: 'Status inválido',
    }),
    estimated_time: zod_1.z
        .number()
